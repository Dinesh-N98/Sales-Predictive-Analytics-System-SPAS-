...
public class ActivityOutcomeDetailDto {
    ...
    public ActivityOutcomeDetailDto() {
    }

    public ActivityOutcomeDetailDto(Integer activityLogId, Integer seId, String seName, Integer clientId,
            String activityName, String prediction, Double probabilitySold, Double probabilityPending,
            Double probabilityRejected) {
        ...
        this.probabilityPending = probabilityPending;
